...
/// Filter icon painter - exact Figma SVG
class _FilterIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Circle 1 (top left)
    canvas.drawCircle(
      Offset(5.03297 * scale, 4.11793 * scale),
      2.28785 * scale,
      paint,
    );
    ...
    // Circle 2 (middle)
    canvas.drawCircle(
      Offset(10.7986 * scale, 10.9812 * scale),
      2.28785 * scale,
      paint,
    );
    ...
    canvas.drawCircle(
      Offset(16.4724 * scale, 17.8455 * scale),
      2.28785 * scale,
      paint,
    );

    // Line 1 (from circle 1 to right)
    canvas.drawLine(
      Offset(7.32129 * scale, 4.11816 * scale),
      Offset(18.7606 * scale, 4.11816 * scale),
      paint,
    );

    // Line 2 (from left to circle 3)
    canvas.drawLine(
      Offset(2.74512 * scale, 17.8447 * scale),
      Offset(14.1844 * scale, 17.8447 * scale),
      paint,
    );

    // Line 3 (from left to circle 2)
    canvas.drawLine(
      Offset(2.74512 * scale, 10.9814 * scale),
      Offset(8.46475 * scale, 10.9814 * scale),
      paint,
    );

    // Line 4 (from circle 2 to right)
    canvas.drawLine(
      Offset(13.0859 * scale, 10.9814 * scale),
      Offset(18.7598 * scale, 10.9814 * scale),
      paint,
    );
  }
