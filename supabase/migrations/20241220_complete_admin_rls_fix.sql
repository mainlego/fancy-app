...
-- ============================================
-- STEP 5: Create NEW policies with admin access
-- ============================================
...
-- DELETE: Only admins can delete profiles (optional)
...
-- ============================================
-- STEP 6: Fix subscriptions table RLS for admins
-- ============================================
...
-- ============================================
-- STEP 7: Fix user_reports table RLS for admins
-- ============================================
...
-- ============================================
-- STEP 8: Fix verification_requests table RLS for admins
-- ============================================
...
-- ============================================
-- STEP 9: Verify the function works
-- ============================================
-- Test: SELECT is_admin(auth.uid());

-- ============================================
-- STEP 10: Set yourself as admin (IMPORTANT!)
-- Uncomment and replace with your actual email or user ID
-- ============================================
